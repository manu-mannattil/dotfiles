...
set wildignore+=*~,*.7z,*.aac,*.anx,*.asf,*.au,*.avi,*.axa,*.axv,*.bin,*.bmp,*.bz,*.bz2,*.cgm,*.class,*.com,*.deb,*.djvu,*.dl,*.dll,*.dmg,*.doc,*.docx,*.dot,*.dotx,*.dvi,*.emf,*.eps,*.exe,*.fla,*.flac,*.flc,*.fli,*.flv,*.gif,*.gl,*.gnumeric,*.gz,*.ipynb,*.iso,*.jar,*.jpeg,*.jpg,*.m2v,*.m4a,*.m4v,*.maff,*.mid,*.midi,*.mka,*.mkv,*.mng,*.mov,*.mp3,*.mp4,*.mp4v,*.mpa,*.mpc,*.mpeg,*.mpg,*.nb,*.nuv,*.o,*.odp,*.odt,*.oga,*.ogg,*.ogm,*.ogv,*.ogx,*.part,*.pcx,*.pdf,*.pdf_tex,*.png,*.pps,*.ppsx,*.ppt,*.pptx,*.ps,*.psd,*.pyc,*.qt,*.ra,*.rar,*.rm,*.rmvb,*.rpm,*.rtf,*.so,*.spx,*.sql,*.sqlite,*.svg,*.svgz,*.swf,*.tar,*.tar.gz,*.tga,*.tgz,*.tif,*.tiff,*.torrent,*.vob,*.wav,*.webm,*.wmv,*.xbm,*.xcf,*.xls,*.xlsx,*.xpm,*.xspf,*.xwd,*.yuv,*.zip,*/__MACOSX/*,*/__pycache__/*,.DS_Store,.Spotlight-V100,.Trash-*/,.Trashes,.directory,.fuse_hidden*,.git/,.hg/,.latex/,Thumbs.db,ehthumbs.db,latex.out/,tags
